...
@extend_schema(
    ...
    examples=[
        ...
        OpenApiExample(
            "Invalid Booking Example - Missing `date` key",
    ...
    @extend_schema(
        ...
        examples=[
            OpenApiExample(
                ...
                value={
                    "message": "Menu item with ID 1 has been deleted successfully."
                },
                status_codes=[status.HTTP_204_NO_CONTENT],
    ...
    parameters=[
        ...
        examples=[
            ...
            OpenApiExample(
                ...
                status_codes=[status.HTTP_405_METHOD_NOT_ALLOWED, status.HTTP_400_BAD_REQUEST],
                response_only=True,
                request_only=False,
            )
        ]
