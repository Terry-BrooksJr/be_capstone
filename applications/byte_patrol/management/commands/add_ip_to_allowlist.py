...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if created:
            self.stdout.write(self.style.SUCCESS(f'Successfully added {ip_address} to the allow list'))
        else:
            self.stdout.write(self.style.SUCCESS(f'Updated existing entry for {ip_address}'))
